    ...
    public static function createdArt(){
        ...
        if (isset($_SESSION['login']))
        {
            ...
            try {
                ...
                /* Set the mail message body. */
                $mail->isHTML(TRUE);
                $mail->Body = "<html>Bonjour, pour valider le nouvel article veuillez vous connecter en tant qu'administrateur puis, veuillez cliquez <a href=\"http://webinfo.iutmontp.univ-montp2.fr/~robertl/AMAP/monAMAP/?action=validatedOne&controller=admin&type=article&id=$idurl\">ici</a>, pour voir toutes les validations en attente veuillez cliquer <a href=\"http://webinfo.iutmontp.univ-montp2.fr/~robertl/AMAP/monAMAP/?action=validate&controller=admin\">ici</a>, il y a actuellement $toValid demandes a valider.</html>";
                $mail->AltBody = "Bonjour, pour valider le nouvel article, veuillez copier coller ce lien dans la barre de navigation http://webinfo.iutmontp.univ-montp2.fr/~robertl/AMAP/monAMAP/?action=validatedOne&controller=admin&type=article&id=$idurl, pour voir toutes les validations en attente veuillez copier coller ce lien dans la barre de navigation http://webinfo.iutmontp.univ-montp2.fr/~robertl/AMAP/monAMAP/?action=validate&controller=admin , il y a actuellement $toValid demandes a valider.";
